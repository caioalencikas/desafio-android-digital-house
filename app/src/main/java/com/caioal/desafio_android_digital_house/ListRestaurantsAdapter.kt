...
class ListRestaurantsAdapter (private val restaurants: List<Restaurant>): RecyclerView.Adapter<ListRestaurantsAdapter.RestaurantViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RestaurantViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_main_item, parent, false)
